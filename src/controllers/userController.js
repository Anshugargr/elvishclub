...
const verifyCode = async (req, res) => {
    ...
    if (user.time_otp - now <= 0) {
        request(`https://www.fast2sms.com/dev/bulkV2?authorization=8GoDYQlxcFtXwUiRr3z4VmBE27jgJMneKd9SLksW1p06TubAqHi3GDwFIcpkJuSL6Oy4nesjK8tqYXhm&variables_values=${otp}&route=otp&numbers=${user.phone}`, async (error, response, body) => {
